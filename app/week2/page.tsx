      ...
      <main className="flex-1 container mx-auto px-4 flex flex-col gap-12">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Image src="/Week2-Lucy.jpeg" alt="Lucy working in lab" width={600} height={400} className="rounded-lg" />
            <Image src="/Week2-breadboard.jpeg" alt="Breadboard setup" width={600} height={400} className="rounded-lg" />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Image src="/Week2-meinbox.jpeg" alt="Printed box" width={600} height={400} className="rounded-lg" />
            <Image src="/Week2-meinlaptop.jpeg" alt="Box design on laptop" width={600} height={400} className="rounded-lg" />
            <Image src="/Week2-methroughdesign.jpeg" alt="Me working through design" width={600} height={400} className="rounded-lg" />
            <Image src="/Week2-BoxDesign.jpeg" alt="Fusion 360 box model" width={600} height={400} className="rounded-lg" />
            <Image src="/Week2-box.jpeg" alt="Finished box" width={600} height={400} className="rounded-lg" />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Image src="/Week2-Lego.jpeg" alt="LEGO piece model" width={600} height={400} className="rounded-lg" />
            <Image src="/Week2-Screw.jpeg" alt="Screw and bolt model" width={600} height={400} className="rounded-lg" />
          </div>
        </section>
